...
/* package pharmalog-0.1.0.0 */
#ifndef VERSION_pharmalog
#define VERSION_pharmalog "0.1.0.0"
#endif /* VERSION_pharmalog */
#ifndef MIN_VERSION_pharmalog
#define MIN_VERSION_pharmalog(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pharmalog */
...
#define CURRENT_COMPONENT_ID "pharmalog-0.1.0.0-9Bh6CgkIb6rKCtAlSjuvwI-pharmalog"
